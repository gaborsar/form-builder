...
import { type FormTreeNodeData, type FormTreeParentNodeData, useIntlState } from "../../../model";
import type { Node } from "../../../utils/tree";
import { useDndProps } from "../hooks/useDndProps";
import { useParentProps } from "../hooks/useParentProps";
import { usePath } from "../hooks/usePath";
import { AppendFormMenuItem } from "./AppendFormMenuItem";
...
interface ParentNodeRendererProps {
  level: number;
  parentPath: string[];
  node: Node<FormTreeParentNodeData, FormTreeNodeData>;
  canMoveUp?: boolean;
  canMoveDown?: boolean;
}
