...
describe("LongText", () => {
  test("type validation", async () => {
    const schema = new LongTextSchema({});
  ...
  test("required field validation", async () => {
    const schema = new LongTextSchema({ required: true, errorMessages });
  ...
  test("min length validation", async () => {
    const schema = new LongTextSchema({ minLength: 3, errorMessages });
  ...
  test("max length validation", async () => {
    const schema = new LongTextSchema({ maxLength: 3, errorMessages });
